        ...
        <div className="kanjiContents">
            <div className="targetKanji">
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={3} alignItems="center" justifyContent="center" alignSelf="flex-end">
                        <h3>Kanji {kanjiNum+1} of 5</h3>
                    </Grid>
                </Grid>
            </div>
            <br/>
            <div className="kanjiGame">
                    ...
                    <Grid item xs={3}>
                        <div className="hints">
                            <Stack direction="column" spacing={2} alignItems="center" justifyContent="center" > 
                                <h1>Hints</h1>
                                {amountShown ? amountShown : <Button variant='outlined' disabled={amountShown} onClick={() => displayAmount()} sx={{width: "100%"}}>How Many Components Are There?</Button>}
                                <Button variant='outlined' onClick={() => showIncorrect()} sx={{width: "100%"}}>Show Incorrect Selections</Button>
                                {!showKanji ? <Button variant='outlined' onClick={() => setShowKanji(true)} sx={{width: "100%"}} >Show what the Kanji looks like!</Button> : <p>The Kanji is shown at the top!</p>}
                            </Stack>
                        </div>
                    </Grid>
                </Grid>
